...
urlpatterns = [
    ...
    path('employee/<int:employee_id>/Ability/new',views.new_ability_handler , name='new_ability'),
    path('employee/<int:employee_id>/Ability/add',views.new_emp_ability_handler , name='new_emp_ability'),
